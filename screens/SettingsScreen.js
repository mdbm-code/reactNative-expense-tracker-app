...
const CustomTextInput = ({ initialValue, onBlur = () => { }, onSubmitEditing = () => { }, onValueChange = () => { }, theme }) => {
...
const Item = ({ item, isEditing, onEdit, onValueChange, onBlur, theme, ignoreInput }) => {
