...
export const Tally = ({ children, color, bg, position }) => {
	...
	const childrenContainer = [styles.childrenContainer, { backgroundColor: color }];

	return (
		<View style={tallyContainer}>
			<View style={{ backgroundColor: color }} ><View style={tallyLeft} /></View>
			<View style={tallyCenter} ><View style={childrenContainer} >{children}</View></View>
			<View style={{ backgroundColor: color }} ><View style={tallyRight} /></View>
		</View>
	)
}
